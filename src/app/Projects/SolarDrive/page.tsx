            ...
            <header className={styles.headerProjects}>
                ...
                <nav className={`${styles.navMobile} ${menuOpen ? styles.open : ''}`}>
                    <ul>
                        ...
                        <li><a href="https://global-solution-2-oau6.vercel.app/" target="_blank" rel="noopener noreferrer">Ver Projeto</a></li>
                        <li><a href="https://github.com/GuiFelSS/Solar-Drive" target="_blank" rel="noopener noreferrer">GitHub</a></li>
                    </ul>
                    <button
